...
export function CTA() {
  return (
    <section className="relative overflow-hidden bg-kanora-cream-2 py-20 md:py-28">
      {/* Ambient animated blobs */}
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="animate-blob absolute -left-20 top-6 h-64 w-64 rounded-full bg-kanora-orange/15 blur-3xl" />
        <div
          className="animate-blob absolute -right-16 bottom-0 h-72 w-72 rounded-full bg-kanora-star/25 blur-3xl"
          style={{ animationDelay: "-5s" }}
        />
        <div
          className="animate-blob absolute left-1/2 top-1/3 h-56 w-56 -translate-x-1/2 rounded-full bg-kanora-orange/10 blur-3xl"
